...
class SmartNotificationTimingTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_donor_with_frequent_work_hour_declines_is_skipped_during_work_hours(): void
    {
        Queue::fake();
        ...
        // Frequent declines during configured work hours (08:00-16:59).
        for ($i = 0; $i < 5; $i++) {
            $historicalRequest = $this->makeBloodRequest($hospital, [
                'status' => 'completed',
                'created_at' => Carbon::parse('2026-03-20 10:00:00')->subDays($i),
                'updated_at' => Carbon::parse('2026-03-20 10:00:00')->subDays($i),
            ]);
            ...
            DonorRequestResponse::create([
                ...
                'blood_request_id' => $historicalRequest->id,
                'response' => 'declined',
                'responded_at' => Carbon::parse('2026-03-20 10:20:00')->subDays($i),
            ]);
        }

        // Positive responses outside work hours should not override work-hour unavailability.
        for ($i = 0; $i < 2; $i++) {
            $historicalRequest = $this->makeBloodRequest($hospital, [
                'status' => 'completed',
                'created_at' => Carbon::parse('2026-03-20 19:00:00')->subDays($i),
                'updated_at' => Carbon::parse('2026-03-20 19:00:00')->subDays($i),
            ]);
            ...
            DonorRequestResponse::create([
                ...
                'blood_request_id' => $historicalRequest->id,
                'response' => 'accepted',
                'responded_at' => Carbon::parse('2026-03-20 19:10:00')->subDays($i),
            ]);
        }
        ...
        $this->assertDatabaseCount('donor_alert_logs', 0);
        Queue::assertNotPushed(SendTimedDonorAlertJob::class);
    }
